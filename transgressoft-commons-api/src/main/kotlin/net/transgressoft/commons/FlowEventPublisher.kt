...
/**
 * Abstract base class that provides reactive event publishing capabilities using Kotlin coroutine flows.
 *
 ...
 * @see SharedFlow
 */
internal class FlowEventPublisher<E : TransEvent> : TransEventPublisher<E> {
